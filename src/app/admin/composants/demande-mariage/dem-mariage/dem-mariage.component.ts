...
@Component({
  selector: 'app-dem-mariage',
  templateUrl: './dem-mariage.component.html',
  styleUrls: ['./dem-mariage.component.css']
})
export class DemMariageComponent implements OnInit {
 ...
 ngOnInit() {
  ...
  this.service.loadListeDemandeParNature("mariage")
  .subscribe((data:any) => {
    console.log(data);
