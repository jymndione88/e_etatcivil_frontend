...
@Component({
  selector: 'app-dem-deces',
  templateUrl: './dem-deces.component.html',
  styleUrls: ['./dem-deces.component.css']
})
export class DemDecesComponent implements OnInit {
 ...
 ngOnInit() {
  ...
  this.service.loadListeDemandeParNature("deces")
  .subscribe((data:any) => {
    console.log(data);
